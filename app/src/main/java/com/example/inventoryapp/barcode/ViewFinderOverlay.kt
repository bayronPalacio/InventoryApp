...
class ViewFinderOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val boxPaint: Paint = Paint().apply {
        ...
        strokeWidth = context.resources.getDimensionPixelOffset(R.dimen._4dp).toFloat()
    }

    private val scrimPaint: Paint = Paint().apply {
        color = ContextCompat.getColor(context, R.color.colorBarcodeBackground)
    }
    ...
    private val boxCornerRadius: Float =
            context.resources.getDimensionPixelOffset(R.dimen._8dp).toFloat()
